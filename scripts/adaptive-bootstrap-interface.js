...
export async function reflectAdaptiveBootstrapInterface() {
  const entries = [
    ...
    [0, 22, "storage", "read_write", null, 16],
  ...
  return reflectGpuInterface({
    interfaceId: "plasius.renderer.adaptive-bootstrap", interfaceVersion: "1.0.0",
    ...
    modelFacingRecordNames: ["RayRecord", "FrameConfig", "Counters", "AdaptiveBootstrapControl", "AdaptiveBootstrapTile"],
